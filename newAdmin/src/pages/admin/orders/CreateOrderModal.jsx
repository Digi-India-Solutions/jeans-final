...
//     console.log("FFFFFFFFF:==>BBBB", newOrderForm)
...
//                                     {/* ✅ Additional Discount — separate field, not a payment row */}
...
//                                                     ...prev,
//                                                     additionalDiscount: cleaned,
//                                                 }));
//                                             }}
//                                             placeholder="0"
//                                             className="w-36 px-3 py-2 border border-yellow-300 rounded-lg focus:ring-2
//                        focus:ring-yellow-400 focus:border-transparent text-sm text-right"
//                                         />
//                                     </div>

//                                     {/* ✅ Payment rows — all tracked in newOrderForm.payments[] */}
...
//                                         {/* Additional discount deduction */}
//                                         {Number(newOrderForm?.additionalDiscount) > 0 && (
//                                             <div className="flex justify-between text-sm text-yellow-700">
//                                                 <span>Additional Discount:</span>
//                                                 <span>− ₹{Number(newOrderForm.additionalDiscount)?.toLocaleString()}</span>
//                                             </div>
//                                         )}
...
//                                         {/* ✅ Balance = orderValue - additionalDiscount - pointsValue - totalPaid */}
//                                         {(() => {
//                                             const balance = Math.max(
//                                                 0,
//                                                 getTotalValue()
//                                                 - Number(newOrderForm?.additionalDiscount || 0)
//                                                 - calculatePointsValue(newOrderForm?.redeemPoints || 0)
//                                                 - getTotalPaidAmount()
//                                             );
//                                             return balance > 0 ? (
...
//                                             <span className={getPaymentType() === "Complete Payment"
//                                                 ? "text-green-600"
//                                                 : "text-yellow-600"
//                                             }>
//                                                 {getPaymentType()}
...
//                                     <div className="flex justify-between text-sm">
//                                         <span>Additional Discount:</span>
//                                         <span className="font-medium text-green-600">₹{Math.max(0, Number(newOrderForm?.additionalDiscount || 0))}</span>
//                                     </div>
//                                     <div className="flex justify-between text-sm">
//                                         <span>Balance:</span>
//                                         <span className="font-medium text-red-600">₹{Math.max(0, (getTotalValue() - calculatePointsValue(newOrderForm?.redeemPoints || 0)) - getTotalPaidAmount())?.toLocaleString()- Number(newOrderForm?.additionalDiscount || 0)}</span>
//                                     </div>
