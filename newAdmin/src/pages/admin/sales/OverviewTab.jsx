...
// function OverviewTab({ salesData }) {
...
//             try {
//                 const res = await getData("api/salesAndReports/get-jeans-shirt-revenue-and-order"); // adjust base URL
...
//                         <p className="text-lg font-bold text-gray-900">₹{(salesDatas?.jeans?.total / 100000).toFixed(1)}L | {salesDatas?.jeans?.pieces} Pcs</p>
//                         <p className="text-sm text-green-600">{salesDatas?.jeans?.growth}% from last month</p>
//                     </div>
//                 </div>
//             </Card>
...
//                         <p className="text-lg font-bold text-gray-900">₹{(salesDatas?.shirts?.total / 100000).toFixed(1)}L | {salesDatas?.shirts?.pieces} Pcs</p>
//                         <p className="text-sm text-green-600">{salesDatas?.shirts?.growth}% from last month</p>
//                     </div>
//                 </div>
//             </Card>
...
//                         <p className="text-lg font-bold text-gray-900">{(salesDatas?.jeans?.orders + salesDatas?.shirts?.orders).toLocaleString()}</p>
//                         <p className="text-sm text-green-600">{salesDatas?.jeans?.growth}% from last month</p>
//                     </div>
//                 </div>
//             </Card>
...
//                         <p className="text-lg font-bold text-gray-900">₹{((salesDatas?.jeans?.total + salesDatas?.shirts?.total) / 100000).toFixed(1)}L | {(salesDatas?.jeans?.pieces + salesDatas?.shirts?.pieces)} Pcs</p>
                ...
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        ...
                        <p className="text-lg font-bold text-gray-900">
                            ₹{formatLakh(salesDatas?.jeans?.total)}K | {salesDatas?.jeans?.pieces || 0} Pcs
                        </p>
            ...
            <Card className="p-6">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-600">Shirts Sales</p>
                        <p className="text-lg font-bold text-gray-900">
                            ₹{formatLakh(salesDatas?.shirts?.total)}K | {salesDatas?.shirts?.pieces || 0} Pcs
                        </p>
                        <p className={`text-sm ${growthClass(salesDatas?.shirts?.growth)}`}>
                            {salesDatas?.shirts?.growth}% from {dateRange === 'thisMonth' ? "last month" : dateRange === 'thisWeek' ? 'last Week' : dateRange === 'thisYear' ? "last Year" : dateRange === ' today' ? ' today' : 'Custom'}
                        </p>
                    </div>
                </div>
            </Card>
            ...
            <Card className="p-6">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-600">Total Revenue</p>
                        <p className="text-lg font-bold text-gray-900">
                            ₹{formatLakh(totalRevenue)}K | {totalPieces} Pcs
                        </p>
