                ...
                <Card className="p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-lg font-bold text-gray-900">₹{(salesData.jeans.total / 1000).toFixed(1)}K | {salesData.jeans.pieces} Pcs</p>
            ...
            <Card className="p-6">
                ...
                <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Total: ₹{(salesData.jeans.total / 1000).toFixed(1)}K | {salesData.jeans.pieces} Pcs</p>
                    </div>
                </div>
            </Card>
        </div>
