...
const { uploadPdf,getAllCataloguePdf,getAllCataloguePdfWithPagination ,deleteCatalogue} = require("./catalogues-controller");
...
router.get("/delete-catalogue/:id",  deleteCatalogue);
