...
const AddProduct = () => {
  ...
  const [formData, setFormData] = useState({ productName: "", categoryId: [], productDescription: "", type: "", productImage: [], Variant: [{ color: "", sizes: [], price: "", discountPrice: "", finalPrice: "", tax: "", },] });
