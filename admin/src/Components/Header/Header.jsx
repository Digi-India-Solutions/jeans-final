...
const Header = () => {
  ...
  const navItems = [
    ...
    { to: "/all-main-category", label: "All Main Category", icon: "fa-solid fa-virus" },
    { to: "/all-dieses", label: "All Sub Category", icon: "fa-solid fa-sitemap" },
    ...
    { to: "/all-notification", label: "Notification", icon: "fa-solid fa-bell" },
